...
public class Pengeluaran extends javax.swing.JDialog {
    ...
    public void noTable(){
        int Baris = pengtab.getRowCount();
        for (int a=0; a<Baris; a++)
        {
            String nomor = String.valueOf(a+1);
            pengtab.setValueAt(nomor +".",a,0);
        }
    }
    ...
    public void dataTable(){
        Object[] Baris = {"No","ID Pengeluaran","Kategori Pengeluaran","Tanggal","Jumlah Pengeluaran","Keterangan","Total Pengeluaran"};
        ...
        try{
            ...
            while (hasil.next()){
                ...
                String kategori_pengeluaran = hasil.getString("kategori_pengeluaran");
                ...
                String [] data = {"",id_pengeluaran,kategori_pengeluaran,tanggal_pengeluaran,jumlah_pengeluaran,keterangan,total_pengeluaran};
                pengtab.addRow(data);
                noTable();
            }
        } catch (Exception e){
    ...
    public void lebarKolom(){
        ...
        column = TabelPengeluaran.getColumnModel().getColumn(0);
        column.setPreferredWidth(40);
        column = TabelPengeluaran.getColumnModel().getColumn(1);
        column.setPreferredWidth(150);
        column = TabelPengeluaran.getColumnModel().getColumn(2);
        column.setPreferredWidth(200);
        column = TabelPengeluaran.getColumnModel().getColumn(3);
        column.setPreferredWidth(150);
        column = TabelPengeluaran.getColumnModel().getColumn(4);
        column.setPreferredWidth(150);
        column = TabelPengeluaran.getColumnModel().getColumn(5);
        column.setPreferredWidth(200);
        column = TabelPengeluaran.getColumnModel().getColumn(6);
    ...
    public void pencarian(String sql){
        Object[] Baris = {"No","ID Pengeluaran","kategori_pengeluaran","Tanggal","Jumlah Pengeluaran","Keterangan","Total Pengeluaran"};
        pengtab = new DefaultTableModel(null, Baris);
        TabelPengeluaran.setModel(pengtab);
    ...
    public Pengeluaran(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        aktif();
        dataTable();
    ...
    private void initComponents() {
        ...
        txtTotalPeng = new javax.swing.JButton();
        ...
        labelNama.setText("Data Pengeluaran");
        ...
        labelId.setText("ID Pengeluaran");
        ...
        labelKategori.setText("Kategori Pengeluaran");
        ...
        labelTanggal.setText("Tanggal Pengeluaran");
        ...
        labelJumlah.setText("Jumlah Pengeluaran");
        ...
        txtKategori.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pengeluaran Operasional", "Hutang Perusahaan", "Pajak" }));

        labelTotal.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        labelTotal.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        labelTotal.setText("Total Pengeluaran");
        ...
        txtTotalPeng.setText("Tampilkan");
        txtTotalPeng.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtTotalPengActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(labelKategori, javax.swing.GroupLayout.DEFAULT_SIZE, 135, Short.MAX_VALUE)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(txtTotalPeng, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                        .addGap(67, 67, 67)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(txtTotalPeng, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))))
    ...
    private void TabelPengeluaranMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabelPengeluaranMouseClicked
        ...
        String c = pengtab.getValueAt(bar, 2).toString();
        String d = pengtab.getValueAt(bar, 3).toString();
        String e = pengtab.getValueAt(bar, 4).toString();
        String f = pengtab.getValueAt(bar, 5).toString();
        String g = pengtab.getValueAt(bar, 6).toString();

        SimpleDateFormat date = new SimpleDateFormat("dd-MM-yyyy");
        Date dateValue = null;
        try{
            dateValue = date.parse((String)TabelPengeluaran.getValueAt(bar, 3));
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        if(txtId.getText().equals("")){
            ...
            JOptionPane.showMessageDialog(null, "Kategori Pengeluaran tidak boleh kosong");
        ...
        try {
            ...
            stat.setString(6, txtTotalPeng.getText());
            stat.executeUpdate();
    ...
    private void btnUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUbahActionPerformed
        String sql = "update pengeluaran set id_pengeluaran=?,kategori_pengeluaran=?,tanggal_pengeluaran=?,"
                + "jumlah_pengeluaran=?,keterangan=?,total_pengeluaran=? where id_pengeluaran='"+txtId.getText()+"'";
        String tampilan = "dd-MM-yyyy";
        SimpleDateFormat fm = new SimpleDateFormat(tampilan);
        String tanggal = String.valueOf(fm.format(txtTanggal.getDate()));
        try {
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        if (ok==0){
            String sql="delete from pengeluaran where id_pengeluaran='"+txtId.getText()+"'";
            try {
                PreparedStatement stat=conn.prepareStatement(sql);
                stat.executeUpdate();
    ...
    private void txtCariKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCariKeyTyped
        String sqlPencarian = "select * from pengeluaran where id_pengeluaran like '%"+txtCari.getText()+"%'"
                + " or kategori_pengeluaran like '%"+txtCari.getText()+"%'";
    ...
    private void txtTotalPengActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtTotalPengActionPerformed
         try {
            ...
            String sum = rs.getString("sum(jumlah_pengeluaran)");
            txtTotalPeng.setText(sum);
            }
        
        } catch(Exception e) {
        JOptionPane.showMessageDialog(null, e);
        } 
    }//GEN-LAST:event_txtTotalPengActionPerformed
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Pengeluaran dialog = new Pengeluaran(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JButton txtTotalPeng;
